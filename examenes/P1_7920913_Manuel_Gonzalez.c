...
int main() {
    ...
    scanf("%f", &balance_ant);
    getchar();
    // Hacemos un while para que el usuario introsuza todas las facturas que quiera
    while (caracter != '='){
      ...
      // comrovamos que caracter pertenece para poder saber si es un ingreso o un egreso
      switch (caracter) {
          case '+':
